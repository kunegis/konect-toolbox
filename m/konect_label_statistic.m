...
elseif strcmp(statistic, 'size_2'),		ret = 'Left size ($n_1$) [vertices]'; 
elseif strcmp(statistic, 'size_3'),		ret = 'Right size ($n_2$) [vertices]'; 
...
elseif strcmp(statistic, 'diam_3'),		ret = '50-percentile effective diameter ($\delta_{0.5}$) [edges]'; 
elseif strcmp(statistic, 'diam_4'),		ret = 'Mean path length ($\delta_m) [edges]'; 
elseif strcmp(statistic, 'avgdegree'), 		ret = 'Average degree ($d$) [edges / vertex]';  
elseif strcmp(statistic, 'avgdegree_4'),	ret = 'Average number of neighbors'; 
elseif strcmp(statistic, 'clusco'),    		ret = 'Clustering coefficient ($c$)'; 
elseif strcmp(statistic, 'clusco_5'),    	ret = 'Relative signed clustering coefficient ($c_r$)'; 
elseif strcmp(statistic, 'clusco_7'),    	ret = 'Clustering coefficient, variant 2 ($c_2$)'; 
elseif strcmp(statistic, 'clusco2'),    	ret = 'Clustering coefficient ($c$)'; 
...
elseif strcmp(statistic, 'coco_2')		ret = 'Relative size of LCC';
elseif strcmp(statistic, 'coco_4')		ret = 'Relative size of left LCC';
elseif strcmp(statistic, 'coco_6')		ret = 'Relative size of right LCC';
elseif strcmp(statistic, 'cocos')		ret = 'Size of LSCC ($N_s$) [vertices]';
elseif strcmp(statistic, 'cocos_2')		ret = 'Relative size of LSCC';
...
elseif strcmp(statistic, 'prefatt_2') 		ret = 'Root-mean-square logarithmic error ($\epsilon$)'; 
elseif strcmp(statistic, 'prefatt_3') 		ret = 'Preferential attachment exponent ($\beta$)'; 
