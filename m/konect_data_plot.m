...
labels_plot.hopdistr___a		= 'hop distribution (linear scale)';
...
labels_plot.hopdistr___g		= 'hop distribution (logarithmic scale)';
...
labels_plot.time_histogram___b		= 'cumulative distribution'; 
